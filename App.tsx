  ...
  <PageWrapper>
    <div className="container mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { icon: <Search />, title: "01. Imersão", desc: "Mergulhamos no DNA da sua hospedagem para entender o perfil do seu hóspede ideal." },
          { icon: <Target />, title: "02. Posicionamento", desc: "Ajustamos a narrativa e o visual para atrair o público A+ que valoriza exclusividade." },
          { icon: <MousePointer2 />, title: "03. Captação", desc: "Campanhas agressivas de tráfego pago nos canais onde seu cliente está agora." },
          { icon: <TrendingUp />, title: "04. Fidelização", desc: "Estratégias de CRM para transformar hóspedes ocasionais em promotores da marca." }
        ].map((item, i) => (
          <motion.div 
            key={i} 
            initial={{ opacity: 0, y: 20 }} 
            ...
            className="glass-card p-8 rounded-3xl border-white/10 group"
          >
            <div className="text-[#CCFF00] mb-6 group-hover:scale-110 transition-transform">{item.icon}</div>
